...
local function drawTabFiltros()
    ...
    -- Input + botùn aùadir manualmente
...
local chatWindow = imgui.OnFrame(
    ...
    function(self)
        ...
        -- Modal de ediciùn al mismo nivel que el contextual (no anidado dentro de ùl)
...
addEventHandler('onWindowMessage', function(msg, wparam, lparam)
    ...
    -- WM_RBUTTONDOWN: calcular quù mensaje estaba bajo el cursor y seùalar apertura del menù
